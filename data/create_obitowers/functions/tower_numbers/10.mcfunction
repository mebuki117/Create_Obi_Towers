...
# execute at @e[type=minecraft:armor_stand,limit=1,tag=cot_dummy] if score cot_dummy cot_towerNo10 matches 125 run function create_obitowers:towers/custom1
