...
summon minecraft:armor_stand -13 1 39 {Tags:["cot_dummy"]}
summon minecraft:armor_stand -34 1 24 {Tags:["cot_dummy"]}
summon minecraft:armor_stand -42 1 -1 {Tags:["cot_dummy"]}
summon minecraft:armor_stand -34 1 -25 {Tags:["cot_dummy"]}
